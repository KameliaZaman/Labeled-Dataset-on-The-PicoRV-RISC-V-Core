...
def read_metadata(dataframe, number_traces):
    """
    Reads a dataframe and returns a0, a1, b0, b1, and r values for the first number_traces entries.
    """
    ...
    return a0_list, a1_list, b0_list, b1_list, r_list
...
if __name__ == "__main__":
    ...
    random_data = 'tv_isw_and.csv' # CSV file with a0, a1, b0, b1, r
    ...
    a0_list, a1_list, b0_list, b1_list, r_list = read_metadata(data, number_of_traces)
    
    # ELF symbol loading
    elf = ELFFile(open(fname, "rb"))
    get_payload = get_symbol_by_name(elf, "isw_and")
    ...
    for i in range(number_of_traces):
        ...
        ql.arch.regs.a2 = int(b0_list[i], 16)
        ql.arch.regs.a3 = int(b1_list[i], 16)
        ql.arch.regs.a4 = int(r_list[i], 16) if isinstance(r_list[i], str) else int(r_list[i])
