...
in_folder = os.path.join("/home/kali/Desktop/RISCV/toffoli/traces_toffoli", in_folder_name)
#print(f"Folder exists: {os.path.exists(in_folder)}")
#print(f"Folder contents: {os.listdir(in_folder)}")
out_folder = os.path.join("/home/kali/Desktop/RISCV/toffoli/traces_toffoli", f"simulated_{leakage_model}")
