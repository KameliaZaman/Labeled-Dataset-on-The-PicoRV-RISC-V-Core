...
in_folder = os.path.join("/home/kali/Desktop/RISCV/isw_and_v1/traces_isw_and", in_folder_name)
#print(f"Folder exists: {os.path.exists(in_folder)}")
#print(f"Folder contents: {os.listdir(in_folder)}")
out_folder = os.path.join("/home/kali/Desktop/RISCV/isw_and_v1/traces_isw_and", f"simulated_{leakage_model}")
